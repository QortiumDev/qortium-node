...
const ENV_PREFIX = 'QORTIUM_NODE';
const DEFAULT_NODE_API_URL = 'http://127.0.0.1:24891';
const DEFAULT_NAME = 'Node';
const DEFAULT_IDENTIFIER = 'Node';
const DEFAULT_TITLE = 'Node';
const DEFAULT_DESCRIPTION = 'A QDN app for inspecting a Qortium node.';
...
async function ensureNameRegistered(name, account) {
  ...
  const rawRegisterBytes58 = buildRegisterNameRawBytes58({
    ...
    data: JSON.stringify({
      app: DEFAULT_TITLE,
      purpose: 'QDN app preview for Node',
    }),
  });
